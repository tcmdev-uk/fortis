...
<main>
  <footer class="py-12 sm:py-16 bg-gray-900">
    <div class="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl">
      <div
        class="grid items-center grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3"
      >
        ...
        <div class="col-span-2 md:col-span-1 md:order-2">
          <ul
            class="flex items-center justify-center sm:justify-between md:justify-center space-x-9 lg:space-x-16"
          >
            <li>
              <a
                href="/"
            ...
            <li>
              <a
                href="/"
                title=""
                class="font-sans text-sm whitespace-nowrap font-normal text-opacity-50 transition-all duration-200 rounded text-white hover:text-opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-primary focus:ring-offset-secondary focus:text-opacity-100"
              >
                Our Work
              </a>
            </li>
